...
{
    public class OldGrass : IRenderable, ISwayable
    {
        ...
        public OldGrass(Vector2 tilePosition, Texture2D texture, Texture2D normalTexture, GraphicsDevice graphicsDevice, Random random)
        {
            _texture = texture;
